...
$sql6 = "SELECT * FROM users WHERE username='".$row['username']."'";
...
if ($row['format'] == 'jpg' or $row['format'] == 'png' or $row['format'] == 'jpeg' or $row['format'] == 'gif') 
{
    echo '<br>
    <div class="post" dir="ltr" style="text-align: left">
    <img src="uploads/'.$row['profile'].'" class="profile"><br>';
    echo'
...
';
                ...
                $sql = "SELECT * FROM follower WHERE follower='$uname3' AND followed='".$row['username']."'";
                $result = $conn->query($sql);
                if ($result->num_rows>0) {

                    require("config.php");

                    $sql7 = "SELECT * FROM posts ORDER BY id DESC";
